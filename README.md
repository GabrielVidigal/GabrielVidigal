# 💫 About Me:
Cursando Ciência da Computação pela Dom Helder no período de 2020 até 2024, como bolsista integral. Sou Desenvolvedor Web com foco em React.js, HTML, CSS e JavaScript para o front-end, e para o back-end, Node.js, Nest.js, além de Java com Spring Boot.

Tenho experiência em trabalhos de freelancer em sites e programas, além de participação em projetos de criação de aplicativos na faculdade Dom Helder. Anteriormente, atuei como estagiário em suporte de TI, fornecendo atendimento ao cliente, resolução de problemas complexos, trabalhando com Excel e realizando manutenções em softwares e hardwares ao longo de um ano.
